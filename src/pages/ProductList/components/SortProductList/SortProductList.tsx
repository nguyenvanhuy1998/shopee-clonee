      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-2 flex'>
            {/*  Prev */}
            {page === 1 ? (
              <span className='flex items-center justify-center shadow px-3 h-8 bg-white/60 rounded-tl-sm rounded-bl-sm hover:bg-slate-100 cursor-not-allowed'>
                <svg
              ...
              <Link
                ...
                className='flex items-center justify-center shadow px-3 h-8 bg-white rounded-tl-sm rounded-bl-sm hover:bg-slate-100'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
