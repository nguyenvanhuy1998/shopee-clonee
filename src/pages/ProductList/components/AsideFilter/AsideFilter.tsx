    ...
    <div className='py-4'>
      ...
      <div className='my-5'>
        ...
        <form className='mt-2' onSubmit={onSubmit}>
          ...
          <Button className='bg-orange w-full p-2 uppercase text-white text-sm hover:bg-orange/80 flex justify-center items-center'>
            Áp dụng
          </Button>
        </form>
      </div>
      ...
      <Button
        ...
        className='bg-orange w-full p-2 uppercase text-white text-sm hover:bg-orange/80 flex justify-center items-center'
      >
        Xóa tất cả
      </Button>
    </div>
